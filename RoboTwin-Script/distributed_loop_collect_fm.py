...
try:
    ...
    wrapper_envs = []
    sys.stdout = open(f"/project/peilab/yanzhengyang/RoboTwin/tmp/{current_time}_stdout.txt", "w")
    ...
    while time.time() - start_time < 3600:
        ...
        # 输出结果到文件
        with open(f"/project/peilab/yanzhengyang/RoboTwin/tmp/{current_time}_gpu_{gpu_idx}_result.pkl", "wb") as f:
    ...
    traceback.print_exc()
    with open(f"/project/peilab/yanzhengyang/RoboTwin/tmp/{current_time}_gpu_{gpu_idx}_error.json", "w") as f:
...
"""
    ...
    for idx in range(gpu_num):
        ...
        # 读取结果文件
        try:
            with open(f"/project/peilab/yanzhengyang/RoboTwin/tmp/{current_time}_gpu_{gpu_idx}_result.pkl", "rb") as f:
                result_data = pickle.load(f)
                results.extend(result_data)
            #os.remove(f"/project/peilab/yanzhengyang/RoboTwin/tmp/gpu_{gpu_idx}_task_{idx}_result.json")
        except Exception as e:
    ...
    #with open(f"/project/peilab/yanzhengyang/RoboTwin/tmp/{current_time}_overall_result.json", "w") as f:
    if file_name != None:
        with open(f"/project/peilab/yanzhengyang/RoboTwin/tmp/{file_name}", "wb") as f:
            data = {
                'time': current_time,
                'results': results,
            }
...
if __name__ == "__main__":
    ...
    run_sapien_distributed_subprocess(usr_args, 8, 16, file_name = "beat_block_hammer.pkl")
