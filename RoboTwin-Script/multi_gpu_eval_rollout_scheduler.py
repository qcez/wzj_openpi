...
def main():
    ...
    parser.add_argument("--file_name", type=str, default="rollout_pkl", help="For rollout")
    parser.add_argument("--save_freq", type=int, default=10, help="Save frequency for rollout")
