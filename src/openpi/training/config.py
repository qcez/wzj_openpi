...
_CONFIGS = [
    # Base config for model conversion
    TrainConfig(
        name="pi0_base",
    ...
    # pi0_base by lora (torch)
    TrainConfig(
        name="pi0_base_aloha_robotwin_lora_torch",
        model=pi0_config.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
            repo_id="beat_block_hammer_repo",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
        ...
        batch_size=32,  # the total batch_size not pre_gpu batch_size
        # weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_base/params"),
        pytorch_weight_path="/project/peilab/wzj/RoboTwin/policy/openpi_test/base_model_pytorch/pi0_base_pytorch",
        num_train_steps=30000,
        fsdp_devices=1,  # refer line 359
    ),
    # pi0_base_torch by full
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_torch",
        model=pi0_config.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="robotwin_aloha_lerobot_repo",  # your datasets repo_id
            # repo_id="fold_cloth-1_8-50_repo",
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
    ...
    TrainConfig(
        ...
        batch_size=32,  # the total batch_size not pre_gpu batch_size
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_base/params"),
        # weight_loader=weight_loaders.CheckpointWeightLoader("/project/peilab/wzj/RoboTwin/policy/openpi_test/checkpoints/pi0_base_aloha_robotwin_lora-0/beat_block_hammer_jax/30000/params"),
        num_train_steps=30000,
        fsdp_devices=1,  # refer line 359
    ),
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(pi05=True),
        data=LeRobotAlohaDataConfig(
            repo_id="beat_block_hammer_repo",
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
    ...
    #2卡测试叠衣服
        TrainConfig(
        name="pi0_base_aloha_folding_full_test",
        model=pi0_config.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="fold_cloth-1_8-50_repo",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
    ...
    #1111111111111111111111111111111111111111
        ...
        model=pi0_config.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="fold_cloth-1_14-200_repo",  # your datasets repo_id
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    "images": {
