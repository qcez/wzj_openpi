...
def create_torch_dataset(
    ...
    # Try to load as local directory first
    import pathlib
    local_path = pathlib.Path(repo_id)
    if local_path.exists() and local_path.is_dir():
        logging.info(f"Loading dataset from local path: {repo_id}")
        ...
        logging.info(f"Loading dataset from HuggingFace Hub: {repo_id}")
